...
export default {
  ...
  props: {
    ...
    original: { type: String, default: "" }, //只有在diff模式下有效
    value: { type: String, default: "hhhhda" },
  ...
  watch: {
    ...
    value: {
      ...
      handler: function(newV) {
        this.editor && newV !== this._getValue() && this._setValue(newV);
      },
    },
    language() {
